        ...
        <div className="relative border-b border-gray-200 py-2">
          ...
          <div className="flex items-center">
            ...
            <input
              ...
              required
              className="pl-8 w-full p-1 bg-transparent border-none focus:outline-none focus:ring-0 text-black placeholder-gray-500"
            />
          </div>
        </div>
        ...
        <div className="relative border-b border-gray-200 py-2">
          ...
          <div className="flex items-center">
            <select
              ...
              onChange={handleChange}
              required
              className="w-full p-1 bg-transparent border-none focus:outline-none focus:ring-0 text-black placeholder-gray-500 appearance-none"
            >
